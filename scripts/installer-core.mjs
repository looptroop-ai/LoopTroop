...
function isWindowsDriveMount(path        , mountTable        )          {
  ...
  for (const line of mountTable.split('\n')) {
    ...
    const decoded = point.replace(/\\(\d{3})/g, (_, code        ) => String.fromCharCode(Number.parseInt(code, 8)))
 ...
 */
function candidateRefusal(directory        , resolved        , context              )                {
 ...
 */
function cachedResolutionHolds(entry                  , context              )          {
