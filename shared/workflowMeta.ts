...
const WORKFLOW_PHASE_DETAILS = {
  ...
  PREPARING_EXECUTION_ENV: {
    ...
    steps: [
      ...
      'Deterministic Retry Handoff: Missing structured results and complete backend command failures receive a local append-only retry note instead of another model call. The live log reports failure analysis, any structured correction, worktree reset, and the next numbered attempt so retry preparation is visible.',
