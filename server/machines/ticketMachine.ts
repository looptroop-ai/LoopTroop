      ...
      on: {
        START: {
          ...
          actions: assign({
            ...
            lockedAiQuestionsEnabled: ({ event }) => event.lockedAiQuestionsEnabled ?? false,
            lockedAiQuestionsSource: ({ event }) => event.lockedAiQuestionsSource ?? null,
            lockedAiQuestionWindow: ({ event }) => event.lockedAiQuestionWindow ?? null,
            lockedAiQuestionWindowSource: ({ event }) => event.lockedAiQuestionWindowSource ?? null,
          }),
        },
