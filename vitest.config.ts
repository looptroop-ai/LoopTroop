...
const clientNodeTests = [
  ...
  'src/components/workspace/__tests__/supplementalArtifacts.test.tsx',
  'src/hooks/__tests__/clearTicketCaches.test.tsx',
  ...
  'src/lib/__tests__/lazyWithChunkReload.test.ts',
  'src/lib/__tests__/profileCouncil.test.ts',
  'src/lib/__tests__/recoveryReload.test.ts',
  'src/lib/__tests__/ticketNormalization.test.ts',
