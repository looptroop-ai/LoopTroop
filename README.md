...
**Needs Node 24.11.0 or newer already installed**, with the npm that came with
...
**Needs Node 24.11.0 or newer**, plus git and `gh`.
</details>
...
**Needs Node 24.11.0 or newer as well as bun** — the launcher is a Node program,
...
**Needs Node 24.11.0 or newer as well as pnpm**, plus git and `gh`.
...
**Needs Node 24.11.0 or newer as well as Yarn**, plus git and `gh`.
...
runtime is separate from the application and package floor: Node `24.11.0+`
