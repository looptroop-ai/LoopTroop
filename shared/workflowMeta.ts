...
const WORKFLOW_PHASE_DETAILS = {
  ...
  WAITING_EXECUTION_SETUP_APPROVAL: {
    ...
    outputs: [
      'An editable `execution_setup_plan` artifact with readiness, temporary setup steps, workspace probes, hook policy, detected-hook evidence, explicit validation commands, diagnostics, and regenerate history.',
